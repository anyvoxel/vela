// Package brooker implement collector for https://brooker.co.za/blog/
package brooker
...
func (c *Collector) ResolvePostContent(_ context.Context, post apitypes.Post) (string, error) {
	...
	postCollector.OnHTML("#post", func(h *colly.HTMLElement) {
		var postBody string
...
func (c *Collector) Start(ctx context.Context, ch chan<- apitypes.Post) error {
	...
	err := c.listCollector.Request("GET", "https://brooker.co.za/blog/", nil, colly.NewContext(), nil)
	if err != nil {
		return err
	}
