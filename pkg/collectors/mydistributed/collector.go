...
func (c *Collector) Start(ctx context.Context, ch chan<- apitypes.Post) error {
	...
	c.listCollector.OnHTML("div.Blog div.blog-posts", func(h *colly.HTMLElement) {
		h.ForEachWithBreak("article.post-outer-container div.post", func(_ int, h *colly.HTMLElement) bool {
			...
			publishedAt := h.ChildText("div.post-header time.published")
